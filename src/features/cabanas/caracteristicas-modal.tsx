  ...
  return (
    <>
                    ...
                    >
                      ...
                      <div className="flex gap-2 shrink-0">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() => {
                            setSelectedDeleteId(caracteristica.id);
      ...
      <DeleteConfirmDialog
        ...
        title="¿Estás seguro que deseas eliminar esta característica?"
        description={`Se eliminará la característica "${
          caracteristicas.find((c) => c.id === selectedDeleteId)?.nombre || ""
        }" permanentemente.`}
        onConfirm={() => {
          if (selectedDeleteId) {
