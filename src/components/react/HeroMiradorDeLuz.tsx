  ...
  return (
    <div className="flex flex-col gap-3 py-4 px-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-base font-medium text-gray-700 min-w-[2rem] text-center">
          {count}
        </span>
        <button
          onClick={onIncrement}
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pt-32 pb-16">
          ...
          <div className="text-center mb-8 md:mb-12">
            {/* Subtítulo */}
            <p className="text-amber-300 text-sm md:text-base font-semibold tracking-[0.3em] uppercase mb-4">
              {subtitulo}
            </p>

            {/* Título principal */}
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-white mb-4 md:mb-6
                         drop-shadow-2xl leading-tight">
              {titulo}
            </h2>

            {/* Descripción */}
            <p className="text-white/90 text-lg md:text-xl lg:text-2xl font-light max-w-2xl mx-auto">
              {descripcion}
            </p>
          </div>
